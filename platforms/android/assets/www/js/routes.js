...
app.config(['$routeProvider', '$httpProvider', '$locationProvider', function ($routeProvider, $httpProvider, $locationProvider) {
    ...
    $routeProvider.when('/tailorlisting/:lat/:long/:nearby/:near/:sec', { templateUrl: 'partials/tailor-listing.html', controller: 'tailorListing-ctrl', reloadOnSearch: false, title: '' });
